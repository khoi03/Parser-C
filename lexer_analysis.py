import re
key_words = {
                "type" : ["int", "float", "double", "char", "long long", "d", "f", "c"],
                "operator":["+","-","*","/",">","<","!=",">=","<=","(",")"],
                "key_word":["if","elif","else","scanf","printf","while", "for"],
                "symbol":{";":"semi-colon","{":"open-curly-bracket", "}":"close-curly-bracket", "\n":"newline", '"':'quotes', "&": "and", ",":"comma", "%": "percent"}
            }
